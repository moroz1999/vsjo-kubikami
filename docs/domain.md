...
- The program opens on a pixel menu before game initialization. Number keys `1` through `5` activate the matching menu item directly, and all visible menu messages are Russian strings stored in `strings`.
