...
- Entering aggression stores the previous free or route behavior for later restoration.
...
- Timer expiration restores the free or route behavior saved when aggression started.
