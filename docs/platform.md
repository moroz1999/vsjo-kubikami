...
- The project is built with `sjasmplus`: `compile.bat` runs `php pack_rooms.php` before `_sjasmplus\\sjasmplus.exe main.a80`, regenerating `rooms/` from `rooms_unpacked/`.
